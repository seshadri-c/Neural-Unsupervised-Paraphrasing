...
def training_testing(train_loader, valid_loader, model, criterion, model_opt, resume):
    ...
    epoch = 0
    checkpoint_dir = "/ssd_scratch/cvit/seshadri_c/temp_NLP/"
    ...
    checkpoint_duplicate_dir = "/scratch/seshadri_c/temp_NLP/"
...
def main():
    ...
    train_loader = load_data(data_1, data_2, batch_size=128, num_workers=10, shuffle=True)
    valid_loader = load_data(data_1, data_2, batch_size=128, num_workers=10, shuffle=False)
    resume = False
