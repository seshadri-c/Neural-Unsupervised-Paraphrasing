...
def test_epoch(epoch, test_loader, model):
	...
	predicted_list = []
	j=0
	os.makedirs("outputs_qqp",exist_ok=True)
	original_stdout = sys.stdout
	num_samples = 500
	with open("outputs_qqp/test_texts_"+str(epoch)+".txt", "a") as f:
		sys.stdout = f
...
def main():
	...
	src_path_2 = "data/prepared_data/src_sent/qqp_src.pkl"

	gt_path_2 = "data/prepared_data/prepared_gt_sent/qqp_gt.pkl"
