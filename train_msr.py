...
def training_testing(train_loader, valid_loader, model, criterion, model_opt, resume):
    ...
    checkpoint_duplicate_dir = "/scratch/seshadri_c/temp_NLP_MSR/"
    ...
    while(1):
        ...
        if(epoch==0):
            with open('train_msr_valid_loss.txt', 'w') as f:
                f.write("Epoch : {} \t Train Loss : {} \t Valid Loss : {}\n".format(epoch, train_loss, valid_loss))
        else:
            with open('train_msr_valid_loss.txt', 'a') as f:
                f.write("Epoch : {} \t Train Loss : {} \t Valid Loss : {}\n".format(epoch, train_loss, valid_loss))
        epoch += 1
...
def main():
    ...
    gt_path_1 = "data/prepared_data/prepared_gt_sent/msr_gt_train.pkl"
